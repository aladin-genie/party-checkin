...
class TestConfig(unittest.TestCase):
    ...
    def test_event_start_utc_matches_expected_cdt_offset(self):
        # EVENT_START_LOCAL is 5:30 PM on Oct 9, 2026, in America/Chicago.
        # Oct 9 is within Central Daylight Time (CDT, UTC-5), so this must
        # convert to 10:30 PM UTC -- not the CST (UTC-6) offset.
        self.assertEqual(config.event_start_utc(), datetime(2026, 10, 9, 22, 30))
